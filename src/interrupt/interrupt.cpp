...
namespace system::init
{
    void initIdt()
    {
        ...
        {
            interruptDescriptorTable[i].setHandler((uint64_t)system::interrupt::irq::irqs[i], 0x08, system::interrupt::entity::InterruptDescriptorAttribute::InterruptGate32, 0);
        }
    }
